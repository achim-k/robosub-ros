...
async def prequal_task(self: Task) -> Task[None, None, None]:
    ...
    await move_to_cv_obj_with_debug("buoy_abydos_serpenscaput", stop_dist=0.5)
    ...
    # await move_to_cv_obj_with_debug("gate_abydos", stop_dist=0)
